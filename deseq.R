...
# convert to tibbles-
dnadmg_tib <- as_tibble(dnadmg_res)
ahr_tib <- as_tibble(ahr_res)
carpxr_tib <- as_tibble(carpxr_res)
...
#plot histograms
ggplot(dnadmg_tib, aes(log2FoldChange))+geom_histogram(fill='cadetblue', color='black')+theme_bw()
ggplot(ahr_tib, aes(log2FoldChange))+geom_histogram(fill='forestgreen', color='black')+theme_bw()
ggplot(carpxr_tib, aes(log2FoldChange))+geom_histogram(fill='coral', color='black')+theme_bw()
#plot scatter plots
ggplot(dnadmg_tib, aes(log2FoldChange, padj))+geom_point()+theme_bw()
ggplot(ahr_tib, aes(log2FoldChange, padj))+geom_point()+theme_bw()
ggplot(carpxr_tib, aes(log2FoldChange, padj))+geom_point()+theme_bw()